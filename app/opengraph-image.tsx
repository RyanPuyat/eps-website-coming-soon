...
export const alt = "EPS Corner — EPS-TOPIK, KLT & SCBT Reviewer for OFWs";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ fontSize: 26, color: "#9FB3D6", marginTop: 28, maxWidth: 820 }}>
          EPS-TOPIK · KLT · SCBT reviewer for Filipino workers preparing for jobs in Korea
        </div>
      </div>
    ),
    { ...size }
